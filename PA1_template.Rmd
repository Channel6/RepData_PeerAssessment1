...
My strategy: Fill in the missing values with the mean for that 5-minute interval. Firstly, create function "meanstepsforinterval" to get the mean steps for a given 5-minute interval.
